...
class FilterService {
  ...
  late final Computed<List<ExercisePath>> cFilteredExercises = computed(
    ...
    options: const ComputedOptions<List<ExercisePath>>(name: 'sIsOnline'),
  );
  ...
  late final Computed<bool> sShowMuscleGroups = computed(
    ...
    options: const ComputedOptions<bool>(name: 'sShowMuscleGroups'),
  );
  ...
  late final Computed<bool> sShowEquipment = computed(
    ...
    options: const ComputedOptions<bool>(name: 'sShowEquipment'),
  );
}
